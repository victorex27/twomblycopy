...
if(isset($_POST['btn-login'])){
	...
	if(!$error){
		...
		$sql = "select * from users where username='$username' AND user_type= 'C' ";
...
<html>
<head>
<title>User class C Log In</title>
<meta charset="utf-8">
    ...
    <div class="container">
	    <div style="width: 500px; margin-top: 100px; margin-left: 300px";>
		     <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
			     <center><h2>User class C Log In<h2></center>
				 <br>
				 <?php
				   if(isset($errorMsg)){
					?>
				...
				<p style="margin-left:270px; margin-top:-47px">Need an account?<span><a class="btn btn-primary" href="user class c sign up.php">Sign Up</a><span></p>
			 </form>
