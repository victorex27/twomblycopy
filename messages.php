...
$result99 = $user->getPersonalPostMessages();
...
if($result99->rowCount() < 1){ echo '<span>You have no messages.</span>';}else{
...
<span>
<i data-toggle="modal" data-toggle="tooltip" title="Reply" data-target="#basicModal98" class="fa fa-black fap fa-reply reply_message"><input type="hidden" value="<?php echo $user_id;?>" class="message_to_user"></i>
</span>
