 ...
 if(isset($_POST['btn-register'])){
	...
	if(!$error){
	    $sql = "insert into users(firstname, lastname, phonenumber, address, location, username, email, password,user_type)
	        values('$firstname', '$lastname', '$phonenumber', '$address', '$location', '$username', '$email', '$password', 'C')";	
...
<html>
<head>
<title>User class C Sign up</title>
    ...
    <div class="container">
	    <div style="width: 500px; margin-top: 50px; margin-left: 300px";>
		     <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
			     <center><h2>User class C Sign Up<h2></center>
				 <br>
				 <?php
				    if(isset($successMsg)){
				?>
				...
				<span class="text-danger"><?php if(isset($errorPassword)) echo $errorPassword; ?></span>
				 ...
				 <p style="margin-left:170px; margin-top: -50px">Already a member?<span><a class="btn btn-primary" href="user class C sign up.php">Log In</a><span></p>
